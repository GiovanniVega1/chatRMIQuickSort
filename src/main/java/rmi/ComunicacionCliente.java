...
public class ComunicacionCliente {
    ...
    public void startClient(String username, JTextArea jTextArea, String ip){
        try {
            String serverUrl = "rmi://"+ip+":1099/ChatService";
    ...
    public void sendResults(String results, String username) throws RemoteException {
    chatService.sendResultsToServer(results, username);
    }
